...
#### Dataset
You can download our created [dataset](https://drive.google.com/drive/folders/1UVn_-HoJXqiC3gPlTHCLDc0Cfuyjj9Z4?usp=sharing) and put `3D_models`into the `Aesthetic_data` folder and put `training_data` into `data` folder for further training and testing. If you download and use the dataset, you agree to the below items:
